...
<body>
    ...
    <main>
        ...
        <?php
            ...
            // Ανάκτηση όλων των προϊόντων από τη συλλογή
            $products = $collection->find();

        ?>

        <h2 style="text-align: center; margin: 2%;">ΟΛΑ ΤΑ ΠΡΟΪΟΝΤΑ</h2>
        <section id="serv">
        <div class="container">
            <div class="row">
                <?php
                ...
                foreach ($products as $product) {
                    ...
                    echo '<a href="product.php?id=' . $product->_id . '">';
                    echo '<img id="pro_id" src="' . $product -> image . '" class="img-fluid">';
                    echo '</a>';
                    echo '<h4><a class="link" href="product.php?id=' . $product->_id . '">' . htmlspecialchars($product['name']) . '</a></h4>';
                    echo '<h4>' . htmlspecialchars($product['price']) . '&euro;</h4>';
                    echo '</div>';
                }
                ?>
            </div>
