    ...
    <main>
        <section class="container text-center mb-4">
            <div class="row text-center gy-2">
                <img src="https://files.ekmcdn.com/82276a/resources/design/blenheim-candles-57.jpg?_=5d1988d5-a8d8-4ea2-ab81-e0bdd9edbd28"
                    height="500" width="100%" alt="">
                <h1>JoJoScent</h1>
                <h3>Η Ιστορία μας</h3>
                <p>Ξεκινήσαμε το ταξίδι μας με μια απλή ιδέα: να προσφέρουμε στους ανθρώπους έναν τρόπο να δημιουργούν
                    μια ατμόσφαιρα που αντικατοπτρίζει την προσωπικότητά τους και τις ειδικές στιγμές της ζωής τους.
                    Κάθε κερί που φτιάχνουμε εδώ στο εργαστήριό μας φέρνει μαζί του την αγάπη, την προσοχή στη
                    λεπτομέρεια και την αφοσίωσή μας στην ποιότητα.
                </p>
                <h3>Οι αξίες μας</h3>
                <p>Στηρίζουμε την ηθική και βιώσιμη παραγωγή, χρησιμοποιώντας μόνο υλικά υψηλής ποιότητας που σέβονται
                    το περιβάλλον. Πιστεύουμε στη διαφορετικότητα των αρωμάτων και στη δημιουργία προϊόντων που
                    καλύπτουν τις διάφορες προτιμήσεις των πελατών μας.
                </p>
                <h3>Το Όραμά μας</h3>
                <p>Το όραμά μας είναι να γίνουμε ο προορισμός σας για κεριά που δημιουργούν μια ατμόσφαιρα ευεξίας και
                    χαλάρωσης. Θέλουμε να σας συνοδεύουμε σε κάθε στιγμή της ζωής σας, προσφέροντας μια εμπειρία
                    αρωματικής απόλαυσης.
                </p>
                <p>Ευχαριστούμε που μοιράζεστε αυτό το ταξίδι μαζί μας!
                </p>
            </div>
        </section>
    </main>
